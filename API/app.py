...
def feed(user_id, user_tipo):
    ...
    #####################################################################################################
        ...
        query_prox_conteudo = 'select * from shae_db.v_obterConteudosComProfessores'
        ...
        dfConteudos_prox.columns = ["idConteudo", "descricao", "tipo", "ordem", "idTopico", "descricao_texto", "url","id_especialista","nome_especialista","user_tipo"]
